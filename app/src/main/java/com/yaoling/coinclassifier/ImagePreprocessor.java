...
public class ImagePreprocessor {
    ...
    public Bitmap preprocessBitmap(final Bitmap bitmap) {
        rgbFrameBitmap = bitmap;

        Assert.assertEquals("Invalid size width", rgbFrameBitmap.getWidth(), bitmap.getWidth());
        Assert.assertEquals("Invalid size height", rgbFrameBitmap.getHeight(), bitmap.getHeight());
